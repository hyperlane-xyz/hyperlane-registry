...
// Must be some chars with '/', followed by additional chars with optional '-' separator (e.g. ABC/xyz or ABC/xyz-mno)
export const WARP_ROUTE_ID_REGEX = /^([a-zA-Z0-9]+)\/([a-z0-9]+(?:-[a-z0-9]+)*)$/;
