...
// Must be some chars with '/', followed by additional chars with optional '-' separator (e.g. ABC/XYZ or ABC/XYZ-NMO)
export const WARP_ROUTE_ID_REGEX = /^([a-zA-Z0-9]+)\/([a-zA-Z0-9]+(?:-[a-zA-Z0-9]+)*)$/;
